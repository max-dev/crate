...
class SplitPointVisitor extends DefaultTraversalSymbolVisitor<
    ...
    static class Context {
        final IdentityArrayList<Symbol> toCollect;
        final IdentityArrayList<Function> aggregates;
        boolean aggregateSeen;

        Context(IdentityArrayList<Symbol> toCollect, IdentityArrayList<Function> aggregates) {
